      ...
      <div className="w-full max-w-md">
        <div className="card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-semibold text-mahogany mb-2">Nombre Completo</label>
              <div className="relative">
                <User className="absolute left-3 top-3 w-5 h-5 text-rose-medium" />
                <input
                  type="text"
                  value={nombre}
          ...
          <p className="text-center text-mahogany text-opacity-70 mt-6">
            ¿Ya tienes cuenta?{' '}
            <Link to="/login" className="text-rose-deep font-semibold hover:text-mahogany">
              Inicia sesión
            </Link>
          </p>
        </div>
